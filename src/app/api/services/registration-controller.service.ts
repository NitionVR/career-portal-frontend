...
[key: string]: string;
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  completeCandidateRegistration$Response(params: CompleteCandidateRegistration$Params, context?: HttpContext): Observable<StrictHttpResponse<{
[key: string]: string;
}>> {
    const obs = completeCandidateRegistration(this.http, this.rootUrl, params, context);
    return obs;
  }
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  completeCandidateRegistration(params: CompleteCandidateRegistration$Params, context?: HttpContext): Observable<{
[key: string]: string;
}> {
    const resp = this.completeCandidateRegistration$Response(params, context);
    return resp.pipe(
      map((r: StrictHttpResponse<{
[key: string]: string;
}>): {
